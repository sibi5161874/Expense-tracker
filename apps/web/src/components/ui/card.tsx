...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Flat: card/background color contrast does the separating, not a ring or shadow.
        ...
        // Opt-in only — a card that isn't actually clickable shouldn't imply it is.
        interactive && "cursor-pointer transition-colors duration-200 hover:bg-accent/40",
        className
      )}
      {...props}
    />
