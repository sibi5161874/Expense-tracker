...
import { getAccounts, getActiveAccounts, createAccount, updateAccount, deleteAccount } from '@repo/shared/queries/config';
import type { AccountInput } from '@repo/shared/schemas';

/** Mirrors apps/web/src/hooks/useAccounts.ts — same shared query functions, RN AuthContext/client. */
