...
import { getCategories, getCategoriesByType, createCategory, updateCategory, deleteCategory } from '@repo/shared/queries/config';
import type { CategoryInput } from '@repo/shared/schemas';

/** Mirrors apps/web/src/hooks/useCategories.ts. */
